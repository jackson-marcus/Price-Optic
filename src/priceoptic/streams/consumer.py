"""Consumer-group reader for the price.ticks stream."""

from __future__ import annotations

from collections.abc import Callable

from priceoptic.streams.producer import InMemoryStream
from priceoptic.streams.schemas import StreamEvent
